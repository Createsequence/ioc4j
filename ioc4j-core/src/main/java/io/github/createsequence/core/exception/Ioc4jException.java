package io.github.createsequence.core.exception;
 ...
 */
public class Ioc4jException extends RuntimeException {
     ...
     */
    public Ioc4jException(String messageTemplate, Object... args) {
     ...
     * @since 1.4
     */
    public Ioc4jException(Throwable cause) {
        super(cause);
    }
