...
import io.github.createsequence.core.support.ParameterNameFinder;
import io.github.createsequence.core.support.SimpleParameterNameFinder;
...
public class ReflectUtilsTest {
    ...
    public void invokeRaw() {
        ...
        Assert.assertThrows(Ioc4jException.class, () -> ReflectUtils.invokeRaw(this, method, "arg0"));
        Assert.assertThrows(Ioc4jException.class, () -> ReflectUtils.invokeRaw(this, method, 12));
        ...
        Assert.assertTrue(ex instanceof Ioc4jException);
    ...
    public void getFieldValue() {
        ...
        Assert.assertThrows(Ioc4jException.class, () -> ReflectUtils.getFieldValue(null, ReflectUtils.getDeclaredField(Foo.class, "flag")));
